...
<?php	$datashow6z = $_POST['dataconsulta']; ?>
...
<form action="cmdmod_ok_consulta.php" autocomplete="off" method="post" name="formcmd">
<u>Reus</u> <br />
...
<input type="hidden" value="<?php echo $datashow6z; ?>" name="dataconsultada" />
</form>
