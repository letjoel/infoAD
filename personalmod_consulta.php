...
<?php	$datashow = $_POST['dataconsinc']; ?>
<?php
...
?>
<form method="post" action="personalmod_ok_consulta.php" autocomplete="off" name="formpersonalmod">
...
<br />
	...
	<input type="hidden" value="<?php echo $datashow;?>" name="dataconsincok" />
</form>
